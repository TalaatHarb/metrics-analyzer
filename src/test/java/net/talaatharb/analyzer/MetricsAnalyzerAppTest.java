...
class MetricsAnalyzerAppTest {
    ...
    void debtScoreShouldReflectHighCcAndLowMiAsHighDebt() {
        ...
        double score = MetricsTab.debtScore(high);
    ...
    void debtScoreShouldBeZeroForZeroCc() {
        ...
        assertEquals(0.0, MetricsTab.debtScore(clean), 0.001);
    }
    ...
    void debtScoreShouldBeHigherForHighCouplingThanLow() {
        ...
        assertTrue(MetricsTab.debtScore(highCoupling) > MetricsTab.debtScore(lowCoupling));
    }
    ...
    void debtScoreShouldBeHigherForLowMiThanHigh() {
        ...
        assertTrue(MetricsTab.debtScore(lowMi) > MetricsTab.debtScore(highMi));
    }
    ...
    void debtScoreShouldClampNegativeMiToZero() {
        ...
        double score = MetricsTab.debtScore(negMi);
